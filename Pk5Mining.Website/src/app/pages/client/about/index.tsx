...
import { Target, Eye, Award, ChevronRight, ChevronLeft, Users } from 'lucide-react';
  ...
  return (
    <div className="pt-24">
      ...
      <section className="py-24 bg-[#1a1a1a]">
        <div className="container mx-auto px-6">
          <AnimatedSection className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">Leadership Team</h2>
