  ...
  return (
    <motion.header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-[#1a1a1a]/95 backdrop-blur-md py-4 shadow-lg"
          : "bg-transparent py-6"
      }`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      ...
      >
        ...
        <div>
          <button
            ...
            className={`w-full py-3 px-4 rounded-lg transition-all flex items-center justify-between ${
              isResponsibilityActive
                ...
                <div className="ml-4 mt-1 border-l-2 border-[#D4AF37]/20">
                  {responsibilityLinks.map((link) => (
                    <Link
                      ...
                      className={`block py-2.5 pl-4 pr-4 rounded-r-lg transition-all ${
                        location.pathname === link.path
