...
export function Footer() {
  const [modalType, setModalType] = useState<"privacy" | "terms" | "">("");

  const isModalOpen = useMemo(() => {
    return modalType === "privacy" || modalType === "terms";
  }, [modalType]);
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Powering industry through responsible mining of strategic
      ...
      <LegalModal
        ...
        mode={modalType as "privacy" | "terms"}
      />
    </>
  );
}
