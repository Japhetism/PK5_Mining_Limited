...
{
    public class AgroMailService : IAgroMailService
    {
        private readonly AgroMailSettings _mailSettings;
        public AgroMailService(IOptions<AgroMailSettings> mailSettingsOptions)
        {
