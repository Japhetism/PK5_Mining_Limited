...
// 1. A clean regex for checking names (alphabets only, minimum 2 characters)
const NAME_REGEX = /^[a-zA-Z]{2,}$/;

// 2. A clean regex for checking a standard LinkedIn profile URL
...
export const applicationSchema = z
  .object({
    firstName: z
      ...
      .regex(NAME_REGEX, "First name must be at least 2 letters and contain only alphabets."),

    lastName: z
      .string()
      .trim()
      .min(1, "Last name is required.")
      .regex(NAME_REGEX, "Last name must be at least 2 letters and contain only alphabets."),
